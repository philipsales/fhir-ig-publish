...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'http://somewhere.org/fhir/uv/myig/StructureDefinition/ext-myExtension']) &lt;= 1">extension with URL = 'http://somewhere.org/fhir/uv/myig/StructureDefinition/ext-myExtension': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
